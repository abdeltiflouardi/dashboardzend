...
class Application_Form_BaseFilterForm extends Zend_Form
{
    ...
    protected $_textDecorator = array(
        ...
        array('HtmlTag', array('tag'             => 'div', 'class'           => 'filter-input text')),
    );
    protected $_selectDecorator = array(
        'ViewHelper',
        'Errors',
        array('Label', array('requiredSuffix' => ' <span class="required">*</span>', 'escape'         => false)),
        array('HtmlTag', array('tag'               => 'div', 'class'             => 'filter-input select')),
    );
    protected $_textareaDecorator = array(
        'ViewHelper',
        'Errors',
        array('Label', array('requiredSuffix' => ' <span class="required">*</span>', 'escape'         => false)),
        array('HtmlTag', array('tag'             => 'div', 'class'           => 'filter-input textarea')),
    );
    protected $_checkboxDecorator = array(
        'ViewHelper',
        'Errors',
        array('Label', array('requiredSuffix' => ' <span class="required">*</span>', 'escape'         => false)),
        array('HtmlTag', array('tag'             => 'div', 'class'           => 'filter-input checkbox')),
    );
    protected $_multiCheckboxDecorator = array(
        ...
        array('HtmlTag', array('tag'             => 'div', 'class'           => 'filter-input multi-checkbox')),

    );
    protected $_submitDecorator = array(
        array('ViewHelper'),
        array('HtmlTag', array('tag'   => 'div', 'class' => 'filter-submit')),
    );
